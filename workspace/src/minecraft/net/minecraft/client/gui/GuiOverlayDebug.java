...
import net.s5gi.clientish;
import net.s5gi.entityculling.EntityCullingModBase;
...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List<String> getDebugInfoRight()
    {
        ...
        List<String> list = Lists.newArrayList(new String[] {
                ...
                String.format("Mem: % 2d%% %03d/%03dMB", new Object[]{
                        Long.valueOf(l * 100L / i), Long.valueOf(bytesToMb(l)), Long.valueOf(bytesToMb(i))}),

                String.format("Allocated: % 2d%% %03dMB", new Object[]{
                ...
                String.format("Display: %dx%d (%s)", new Object[]{
                ...
                "You are running:",
                clientish.name + " v" + clientish.version
        });
