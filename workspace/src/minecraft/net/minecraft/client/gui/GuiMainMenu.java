...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private void addSingleplayerMultiplayerButtons(int x, int spacing)
    {
        this.buttonList.add(new GuiButton(1, this.width / 2 - 100, x, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, x+spacing * 1, I18n.format("menu.multiplayer", new Object[0])));
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, x+spacing * 2, "Clientish Options"));

        if (Reflector.GuiModList_Constructor.exists())
        {
            this.buttonList.add(this.modButton = new GuiButton(6, this.width / 2 - 100, x+spacing * 3, 98, 20, I18n.format("fml.menu.mods", new Object[0])));
        }
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id == 3)
        {
            this.mc.displayGuiScreen(new ClientishOptions(this));
        }
