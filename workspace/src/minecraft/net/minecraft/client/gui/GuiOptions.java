...
import net.s5gi.gui.ClientishOptions;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        for (GameSettings.Options gamesettings$options : field_146440_f)
        {
            ...
            {
                this.buttonList.add(new GuiOptionSlider(gamesettings$options.returnEnumOrdinal(), this.width / 2 - 155, this.height / 6 + 42 + offset, gamesettings$options));
            }
            else
            {
        ...
        this.buttonList.add(new GuiButton(110, this.width / 2 + 5, this.height / 6 + 42 + offset, 150, 20, I18n.format("options.skinCustomisation", new Object[0])));
        this.buttonList.add(new GuiButton(106, this.width / 2 - 155, this.height / 6 + 66 + offset, 150, 20, I18n.format("options.sounds", new Object[0])));
        this.buttonList.add(new GuiButton(9090, this.width / 2 + 5, this.height / 6 + 66 + offset, 150, 20, "Client-ish Options"));
        this.buttonList.add(new GuiButton(101, this.width / 2 - 155, this.height / 6 + 90 + offset, 150, 20, I18n.format("options.video", new Object[0])));
        this.buttonList.add(new GuiButton(100, this.width / 2 + 5, this.height / 6 + 90 + offset, 150, 20, I18n.format("options.controls", new Object[0])));
        this.buttonList.add(new GuiButton(102, this.width / 2 - 155, this.height / 6 + 114 + offset, 150, 20, I18n.format("options.language", new Object[0])));
        this.buttonList.add(new GuiButton(103, this.width / 2 + 5, this.height / 6 + 114 + offset, 150, 20, I18n.format("options.chat.title", new Object[0])));
        this.buttonList.add(new GuiButton(105, this.width / 2 - 155, this.height / 6 + 138 + offset, 150, 20, I18n.format("options.resourcepack", new Object[0])));
        this.buttonList.add(new GuiButton(104, this.width / 2 + 5, this.height / 6 + 138 + offset, 150, 20, I18n.format("options.snooper.view", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            {
                this.mc.gameSettings.saveOptions();
                mc.displayGuiScreen(new ClientishOptions(this));
            }
        }
    }
