...
import net.s5gi.entityculling.access.Cullable;
import net.s5gi.entityculling.access.EntityRendererI;
...
public class RenderManager
{
    ...
    public boolean doRenderEntity(Entity entity, double x, double y, double z, float entityYaw, float partialTicks, boolean hideDebugBox)
    {
        ...
        if (!cullable.isForcedVisible() && cullable.isCulled()) {
            EntityRendererI<Entity> entityRenderer = (EntityRendererI) getEntityRenderObject(entity);
