...
public class Stitcher {
   ...
   private boolean func_94311_c(Stitcher.Holder p_94311_1_) {
      ...
      boolean flag1;
      if(this.field_94314_g) {
         int j = MathHelper.func_151236_b(this.field_94318_c);
      ...
      int j1 = Math.max(p_94311_1_.func_94197_a(), p_94311_1_.func_94199_b());
      if(MathHelper.func_151236_b((flag1?this.field_94315_d:this.field_94318_c) + j1) > (flag1?this.field_94313_f:this.field_94316_e)) {
         return false;
      } else {
