...
public class CommandSpreadPlayers extends CommandBase {
   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
      if(p_71515_2_.length < 6) {
         ...
         double d0 = func_175761_b((double)blockpos.func_177958_n(), p_71515_2_[i++], true);
         double d1 = func_175761_b((double)blockpos.func_177952_p(), p_71515_2_[i++], true);
         double d2 = func_180526_a(p_71515_2_[i++], 0.0D);
         double d3 = func_180526_a(p_71515_2_[i++], d2 + 1.0D);
         boolean flag = func_180527_d(p_71515_2_[i++]);
         List<Entity> list = Lists.<Entity>newArrayList();

         while(i < p_71515_2_.length) {
            String s = p_71515_2_[i++];
            if(PlayerSelector.func_82378_b(s)) {
               List<Entity> list1 = PlayerSelector.<Entity>func_179656_b(p_71515_1_, s, Entity.class);
               if(list1.size() == 0) {
               ...
               EntityPlayer entityplayer = MinecraftServer.func_71276_C().func_71203_ab().func_152612_a(s);
         ...
         p_71515_1_.func_174794_a(CommandResultStats.Type.AFFECTED_ENTITIES, list.size());
         if(list.isEmpty()) {
            throw new EntityNotFoundException();
         } else {
            p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.spreadplayers.spreading." + (flag?"teams":"players"), new Object[]{Integer.valueOf(list.size()), Double.valueOf(d3), Double.valueOf(d0), Double.valueOf(d1), Double.valueOf(d2)}));
            this.func_110669_a(p_71515_1_, list, new CommandSpreadPlayers.Position(d0, d1), d2, d3, ((Entity)list.get(0)).field_70170_p, flag);
         }
      }
   }
   ...
   private void func_110669_a(ICommandSender p_110669_1_, List<Entity> p_110669_2_, CommandSpreadPlayers.Position p_110669_3_, double p_110669_4_, double p_110669_6_, World p_110669_8_, boolean p_110669_9_) throws CommandException {
      ...
      if(acommandspreadplayers$position.length > 1) {
         p_110669_1_.func_145747_a(new ChatComponentTranslation("commands.spreadplayers.info." + (p_110669_9_?"teams":"players"), new Object[]{String.format("%.2f", new Object[]{Double.valueOf(d4)}), Integer.valueOf(i)}));
      }
   ...
   private double func_110671_a(List<Entity> p_110671_1_, World p_110671_2_, CommandSpreadPlayers.Position[] p_110671_3_, boolean p_110671_4_) {
      ...
      for(int j = 0; j < p_110671_1_.size(); ++j) {
         ...
         if(p_110671_4_) {
            Team team = entity instanceof EntityPlayer?((EntityPlayer)entity).func_96124_cp():null;
   ...
   static class Position {
      ...
      public int func_111092_a(World p_111092_1_) {
         ...
         while(blockpos.func_177956_o() > 0) {
            ...
            if(p_111092_1_.func_180495_p(blockpos).func_177230_c().func_149688_o() != Material.field_151579_a) {
      ...
      public boolean func_111098_b(World p_111098_1_) {
         ...
         while(blockpos.func_177956_o() > 0) {
            blockpos = blockpos.func_177977_b();
            Material material = p_111098_1_.func_180495_p(blockpos).func_177230_c().func_149688_o();
