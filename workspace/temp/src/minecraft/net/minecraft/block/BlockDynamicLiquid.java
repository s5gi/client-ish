...
public class BlockDynamicLiquid extends BlockLiquid {
   ...
   public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_) {
      ...
      if(i > 0) {
         ...
         if(this.func_176362_e(p_180650_1_, p_180650_2_.func_177984_a()) >= 0) {
            int j1 = this.func_176362_e(p_180650_1_, p_180650_2_.func_177984_a());
            if(j1 >= 8) {
               i1 = j1;
            } else {
               i1 = j1 + 8;
         ...
         if(this.field_149815_a >= 2 && this.field_149764_J == Material.field_151586_h) {
            ...
            if(iblockstate1.func_177230_c().func_149688_o().func_76220_a()) {
               i1 = 0;
            } else if(iblockstate1.func_177230_c().func_149688_o() == this.field_149764_J && ((Integer)iblockstate1.func_177229_b(field_176367_b)).intValue() == 0) {
               i1 = 0;
            }
         }
      ...
      if(this.func_176373_h(p_180650_1_, p_180650_2_.func_177977_b(), iblockstate)) {
         ...
         if(i >= 8) {
            this.func_176375_a(p_180650_1_, p_180650_2_.func_177977_b(), iblockstate, i);
         } else {
            this.func_176375_a(p_180650_1_, p_180650_2_.func_177977_b(), iblockstate, i + 8);
         }
      } else if(i >= 0 && (i == 0 || this.func_176372_g(p_180650_1_, p_180650_2_.func_177977_b(), iblockstate))) {
   ...
   private int func_176374_a(World p_176374_1_, BlockPos p_176374_2_, int p_176374_3_, EnumFacing p_176374_4_) {
      ...
      for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
         if(enumfacing != p_176374_4_) {
            ...
            if(!this.func_176372_g(p_176374_1_, blockpos, iblockstate) && (iblockstate.func_177230_c().func_149688_o() != this.field_149764_J || ((Integer)iblockstate.func_177229_b(field_176367_b)).intValue() > 0)) {
   ...
   private Set<EnumFacing> func_176376_e(World p_176376_1_, BlockPos p_176376_2_) {
      ...
      for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
         ...
         if(!this.func_176372_g(p_176376_1_, blockpos, iblockstate) && (iblockstate.func_177230_c().func_149688_o() != this.field_149764_J || ((Integer)iblockstate.func_177229_b(field_176367_b)).intValue() > 0)) {
            int j;
   ...
   private boolean func_176372_g(World p_176372_1_, BlockPos p_176372_2_, IBlockState p_176372_3_) {
      ...
      return !(block instanceof BlockDoor) && block != Blocks.field_150472_an && block != Blocks.field_150468_ap && block != Blocks.field_150436_aH?(block.field_149764_J == Material.field_151567_E?true:block.field_149764_J.func_76230_c()):true;
   }

   protected int func_176371_a(World p_176371_1_, BlockPos p_176371_2_, int p_176371_3_) {
      int i = this.func_176362_e(p_176371_1_, p_176371_2_);
      if(i < 0) {
         return p_176371_3_;
      } else {
         if(i == 0) {
   ...
   private boolean func_176373_h(World p_176373_1_, BlockPos p_176373_2_, IBlockState p_176373_3_) {
      Material material = p_176373_3_.func_177230_c().func_149688_o();
